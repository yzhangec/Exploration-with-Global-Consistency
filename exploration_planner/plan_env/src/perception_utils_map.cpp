...
PerceptionUtilsMap::PerceptionUtilsMap(ros::NodeHandle& nh) {
...
void PerceptionUtilsMap::setPose(const Vector3d& pos, const double& yaw) {
  pos_ = pos;
  yaw_ = yaw;
...
void PerceptionUtilsMap::getFOV(vector<Vector3d>& list1, vector<Vector3d>& list2) {
  list1.clear();
  list2.clear();
...
bool PerceptionUtilsMap::insideFOV(const Vector3d& point) {
...
void PerceptionUtilsMap::getFOVBoundingBox(Vector3d& bmin, Vector3d& bmax) {
