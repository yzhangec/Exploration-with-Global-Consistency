...
void RayCaster::setParams(const double& res, const Eigen::Vector3d& origin) {
  ...
  // std::cout << "origin / resolution_: " << (origin / resolution_).transpose() << std::endl;
}

bool RayCaster::input(const Eigen::Vector3d& start, const Eigen::Vector3d& end) {
  start_ = start / resolution_;
  end_ = end / resolution_;
  // std::cout << "start_: " << start_.transpose() << std::endl;
  // std::cout << "end_: " << end_.transpose() << std::endl;

  x_ = (int)std::floor(start_.x());
  y_ = (int)std::floor(start_.y());
  z_ = (int)std::floor(start_.z());
  // std::cout << "start: " << x_ << " " << y_ << " " << z_ << std::endl;
  endX_ = (int)std::floor(end_.x());
  endY_ = (int)std::floor(end_.y());
  endZ_ = (int)std::floor(end_.z());
  // std::cout << "end: " << endX_ << " " << endY_ << " " << endZ_ << std::endl;
  ...
  // std::cout << "dxyz: " << dx_ << " " << dy_ << " " << dz_ << std::endl;
  ...
  // std::cout << "stepXYZ: " << stepX_ << " " << stepY_ << " " << stepZ_ << std::endl;
  ...
  // std::cout << "tMaxXYZ: " << tMaxX_ << " " << tMaxY_ << " " << tMaxZ_ << std::endl;
  ...
  // std::cout << "tDeltaXYZ: " << tDeltaX_ << " " << tDeltaY_ << " " << tDeltaZ_ << std::endl;
...
bool RayCaster::nextId(Eigen::Vector3i& idx) {
  ...
  // std::cout << "xyz_: " << x_ << " " << y_ << " " << z_ << std::endl;
  // std::cout << "tMaxXYZ: " << tMaxX_ << " " << tMaxY_ << " " << tMaxZ_ << std::endl;
  // std::cout << "tDeltaXYZ: " << tDeltaX_ << " " << tDeltaY_ << " " << tDeltaZ_ << std::endl;
