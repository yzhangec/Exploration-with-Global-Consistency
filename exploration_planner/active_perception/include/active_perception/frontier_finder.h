...
class FrontierFinder {
 public:
  ...
  void getFullCostMatrix(const Vector3d& cur_pos, const Vector3d& cur_vel, const Vector3d cur_yaw,
                         Eigen::MatrixXd& mat);
  void getFullCostMatrixWithALCPoints(const Vector3d& cur_pos, const Vector3d& cur_vel,
                                      const Vector3d cur_yaw,
                                      const vector<Eigen::Vector3d>& alc_points,
                                      const vector<double>& alc_yaw, Eigen::MatrixXd& mat);
  void getNearestALCPoint(const Vector3d& cur_pos, const Vector3d& cur_vel, const Vector3d cur_yaw,
                          const vector<Eigen::Vector3d>& alc_points, const vector<double>& alc_yaws,
                          Eigen::Vector3d& alc_point, double& alc_yaw, int &idx);
  void getFullCostMatrixFromNearestALCPoint(const Eigen::Vector3d& alc_point, const double& alc_yaw,
  ...
  void updateALCClusters(const vector<Eigen::Vector3d>& points, const vector<double>& yaws,
 ...
 private:
  ...
  vector<ALCCluster> alc_clusters_, frontier_and_alc_clusters_;
